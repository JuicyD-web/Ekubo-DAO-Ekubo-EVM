...
contract ERC20Mock is ERC20 {
    ...
    function safeTransferAllFrom(address token, address from, address to) public {
        SafeTransferLib.safeTransferAllFrom(token, from, to);
    }
